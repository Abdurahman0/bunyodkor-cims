export const translations = {
  ...
  ru: {
    ...
    comprehensiveStudentsExport: "Полный экспорт студентов",
    comprehensiveStudentsExportDescription:
      "Экспортируйте полные данные с фильтрами по диапазону дат, группе и статусу.",
    ...
    spravkaMonthsLabel: "Месяц для справки",
    ...
    replaceContractPdfDescription:
      "Укажите причину расторжения договора",
