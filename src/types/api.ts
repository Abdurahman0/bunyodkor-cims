...
export interface RoleWithPermissions extends RoleRead {
  [x: string]: any // Changed to 'any' to allow for 'permissions' property which is an array, not a number.
...
export type TransactionStatus = 'pending' | 'success' | 'failed' | 'cancelled' | 'unassigned'
